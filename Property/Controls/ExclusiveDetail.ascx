            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="property_inner_cntnt">
                    <ul class="w4rlisting-list-b">
                        ...
                        <li class="a"><span>
                            <asp:Label ID="lblstatus" runat="server" Text=""></asp:Label></span>Status</li>
                        <li class="a"><span>
                            <asp:Label ID="lblAddress" runat="server" Text=""></asp:Label></span>Address</li>
                       
                </div>

                <div class="construction_detail"><span ><asp:Label id="Description" runat="server" Text=""></asp:Label></span></div>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="roco_pro_info">
                        <h2 style="font-size: 19px !important">
                            <asp:Label ID="lblname" runat="server"></asp:Label>Rajiv Bakshi</h2>
