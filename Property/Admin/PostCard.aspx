                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Rajiv Bakshi</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-274-8820</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: rbakshi274@gmail.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.buysellrentrealestate.ca</p>
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_second_imge" data-id="featured_second" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_second_img" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:250px;" />
                                        </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Rajiv Bakshi(Sales Representative)</h2>
...
<img id="ftr_2nd_1stimge" src="../PostCardImages/featurd_img1.png" alt="" title="" style="width:100%; height:400px;" />
                            </div>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Rajiv Bakshi</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newsltr_bg" id="jst_sold_front" style="display: none">
                        <div style="float: left; width: 98%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%;">
                                <img id="jsthold_1stimge" data-id="jsthold_1stimge" src="../PostCardImages/featurd_img1.png" alt="" title="" style="width:100%; height:400px;" />
                            </div>
                            <div style="float: left; width: 100%;">
                                ...
                                <div style="float: left; width: 100%; margin: 4px 0;">
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_2ndimge" data-id="jsthold_2ndimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_3rdimge" data-id="jsthold_3rdimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_4thimge" data-id="jsthold_4thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_5thimge" data-id="jsthold_5thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_6thimge" data-id="jsthold_6thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_7thimge" data-id="jsthold_7thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:200px;" />
