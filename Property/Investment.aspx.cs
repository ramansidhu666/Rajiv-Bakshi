...
namespace Property
{
    public partial class Investment : System.Web.UI.Page
    {
        ...
        void ddlProperty_SelectedIndexChanged(object sender, EventArgs e)
        {

            if (ddlProperty.SelectedValue.ToString() == "Commercial")
            {
                ddlPtypeDetails.Items.Clear();
                ddlPtypeDetails.Items.Add(new ListItem("Store"));
                ddlPtypeDetails.Items.Add(new ListItem("Office"));
                ddlPtypeDetails.Items.Add(new ListItem("Other"));
            }
            else if (ddlProperty.SelectedValue.ToString() == "Residential")
            {
                ddlPtypeDetails.Items.Clear();
                ddlPtypeDetails.Items.Add(new ListItem("House"));
                ddlPtypeDetails.Items.Add(new ListItem("Condo"));
                ddlPtypeDetails.Items.Add(new ListItem("Basement"));
            }
            else
            {
                ddlPtypeDetails.Items.Clear();
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            body = body + "<p>Phone no : " + txtPhoneno.Text + "</p>";
            body = body + "<p>Price Range : " + ddlPriceRange.SelectedValue + "</p>";

            body = body + "<p>Property Type: " + prop + "</p>";
            body = body + "<p>Property Type Details: " + detailss + "</p>";
            body = body + "<p>Type : " + DropDownList1.SelectedValue + "</p>";
            body = body + "<p>City : " + ddlCity.SelectedValue + "</p>";
            body = body + "<p>Remarks : " + txtRemarks.Text + "</p>";
            mail.Body = body;
