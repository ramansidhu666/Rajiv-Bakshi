...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://buysellrentrealestate.ca/landing_page.aspx';
            ...
            <div class="free_nw_cls_bg">
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="review_home_worth_land_1">
                        ...
                        <%--<a href="#" id="shareBtn" style="background-color:gold;float: right;height: 24px;margin-right: 300px;border-radius:9px;border: 2px solid black;  padding: 4px 12px;" class="btn btn-success clearfix">Share Me</a>--%>
                    </div>
                </div>
            </div>
            </div>
